package com.tengjiao.distribute.registry.web.interceptor;

import com.tengjiao.distribute.registry.web.annotation.PermessionLimit;
import com.tengjiao.distribute.registry.util.CookieUtil;
...
public class PermissionInterceptor extends HandlerInterceptorAdapter implements InitializingBean {
    ...
    @Value("${tengjiao.distribute.registry.login.username}")
    private String username;
    @Value("${tengjiao.distribute.registry.login.password}")
